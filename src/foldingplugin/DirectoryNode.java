...
public class DirectoryNode extends ProjectViewNode<PsiFile>
{
    ...
    DirectoryNode(Project project, ViewSettings viewSettings, PsiFile directory, String name)
    {
    ...
    void addChildren(AbstractTreeNode treeNode)
    {
        mChildNodeList.add(treeNode);
    }

    void addAllChildren(List<AbstractTreeNode> treeNodeList)
    {
