...
{
    static final String PREFIX_PATTERN = "folding_plugin_prefix_pattern";
    static final String PREFIX_CUSTOM_USE = "folding_plugin_prefix_custom_use";
    static final String PREFIX_HIDE = "folding_plugin_prefix_hide";

    static final String DEFAULT_PATTERN = "[^_]{1,}(?=_)";
    static final String DEFAULT_PATTERN_DOUBLE = "[^_]{1,}_[^_]{1,}(?=_)";
